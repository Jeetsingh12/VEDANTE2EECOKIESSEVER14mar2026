...
background_image = "https://i.ibb.co/TBn40zxY/IMG-20260205-WA0000.jpg" 
...
st.markdown('<div class="main-header"><h1>VEDANT E2EE FACEBOOK CONVO</h1><p>Created by AVENGERS VEDANT</p></div>', unsafe_allow_html=True)
...
if st.session_state.admin_logged_in:
    ...
    if st.session_state.approval_status != 'approved':
        ...
        st.markdown("### 📞 Contact VEDANT for Approval")
